...
test('get default string', function() {
	equal(Wee.$get('var-123', 'string'), 'string', 'Variable "var-123" is set to the default "string".');
	equal(Wee.$get('123 var', 'Testing 123'), 'Testing 123', 'Variable "123 var" is set to the default "Testing 123".');
});
